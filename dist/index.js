...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let targetGroupArn = yield target_group_management_1.deleteTargetGroup({
            targetGroup: core_1.getInput("target-group"),
            failIfNoMatch: core_1.getInput("fail-if-no-match") == "true",
        });
        if (targetGroupArn) {
            core_1.info(`Target group ARN: ${targetGroupArn}`);
            core_1.setOutput("target-group-arn", targetGroupArn);
        }
        return 0;
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deleteTargetGroup = void 0;
...
function findTargetGroup(inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        const { failIfNoMatch, targetGroup: targetGroupName } = inputs;
        try {
            const { TargetGroups } = yield getClient()
                .describeTargetGroups({
                Names: [targetGroupName],
            })
                .promise();
            const targetGroup = TargetGroups === null || TargetGroups === void 0 ? void 0 : TargetGroups.pop();
            if (!targetGroup)
...
function deleteTargetGroup(inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        validateInputs(inputs);
        const { targetGroup } = inputs;
        let TargetGroupArn;
        if (!targetGroup.startsWith("arn:")) {
            const group = yield findTargetGroup(inputs);
            TargetGroupArn = group === null || group === void 0 ? void 0 : group.TargetGroupArn;
        }
        else
