...
ARG APP_PATH=/icalia-actions/aws-delete-elb-target-group
...
ARG APP_PATH=/icalia-actions/aws-delete-elb-target-group
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/aws-delete-elb-target-group
WORKDIR /icalia-actions/aws-delete-elb-target-group
